# -*- coding : utf-8 -*-
# @FileName  : FSC147_2.py
# @Author    : Ruixiang JIANG (Songrise)
# @Time      : Aug 13, 2023
# @Github    : https://github.com/songrise
# @Description: FSC_147 dataset. Implementation borrowed from CounTR.
import json
import numpy as np
import random
...
class FSC147(Dataset):
    def __init__(self,
        ...
        self.data_split_file = os.path.join(self.data_dir, self.dataset_type,
                                            f'Train_Test_Val_{self.dataset_type}.json')
    ...
    def __getitem__(self, idx):
        ...
        if self.split == 'train' or (self.split == 'val' and self.resize_val):
            ...
            if self.use_additional_prompt:
                return sample['image'].float(), sample['gt_density'], text
            return sample['image'].float(), sample['gt_density'], text
            ...
            return sample['image'].float(), sample['gt_map'], text
